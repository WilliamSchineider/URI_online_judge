...
store the result in a variable named PROD. Print the result like the example below.
...
Output
Print the message "PROD" and PROD according to the following example, with a blank
